<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/UserHomemaster.master" AutoEventWireup="true" CodeFile="UserMain.aspx.cs" Inherits="eg" %>
    ...
    <div class="container">
        ...
        <div class="row">
            <asp:Repeater ID="RepeatBooks" runat="server">
				...
				<div class="image">
					<a href="User/UserBookDetails.aspx?bid=<%#Eval("BID") %>">
				...
				<br /><a class="btn btn-primary" href="User/UserBookDetails.aspx?bid=<%#Eval("BID") %>">View Book</a>
                </div>
              </ItemTemplate>
          </asp:Repeater>
          </div>
