...
public partial class contus : System.Web.UI.Page
{
        ...
        try
        {
            if (fullname.Text != "" && mail.Text != "" && contact.Text != "" && msgbox.Text != "")
            {
                if (contact.Text.Length == 10)
                {
                    ...
                    Response.Write("<script language='javascript'>window.alert('Complaint Registered Successfully');window.location='main.aspx';</script>");
                }
                else
                {
