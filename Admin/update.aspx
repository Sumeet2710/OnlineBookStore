<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminHomemaster.master" AutoEventWireup="true" CodeFile="update.aspx.cs" Inherits="Admin_update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="wrapper">
        <h3 style="border-bottom:solid gray 1.5px;font-family:sans-serif;"><b>Update Books</b></h3>
        ...
        <div class="col-xs-11">
        <asp:TextBox ID="bookisbn" runat="server" CssClass="form-control" placeholder="Book ISBN"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" CssClass="danger" ErrorMessage="This Field is Required" ControlToValidate="bookdesc" ValidationGroup="req" Display="Dynamic"></asp:RequiredFieldValidator>
    </div>
        <div class="col-xs-11 space-vert">
        <asp:Button ID="updateBooks" runat="server" Text="Update Book" CssClass="btn btn-danger" ValidationGroup="req" OnClick="updateBooks_Click" />
         </div>
        </div>
        </div>
</asp:Content>
