<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/UserHomemaster.master" AutoEventWireup="true" CodeFile="UsrAddCart.aspx.cs" Inherits="User_UsrAddCart" %>
...
<h5 class="text-danger font-weight-bold">My Cart (<span><asp:Label ID="LCount" runat="server" Text=""></asp:Label></span> Books)</h5>
