<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/UserHomemaster.master" AutoEventWireup="true" CodeFile="UserBookDetails.aspx.cs" Inherits="User_UserBookDetails" %>
...
<table class="table table-borderless">
  <tbody>
    ...
    <tr>
     <td><div class="row">
   <a class="btn btn-danger"  style="margin-left:60px;"><asp:Button ID="buyBtn" runat="server" OnClick="buyBtn_Click" Text="Buy Book" CssClass="btn btn-danger" ClientIDMode="Static" /></a>
